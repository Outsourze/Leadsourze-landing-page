            ...
            lg:flex-row md:flex-col max-md:flex-col">
                <div className="flex gap-10 
                    ...
                    <div className="flex flex-col gap-5 items-start shadow-2 px-6 py-10 rounded-2xl
                        ...
                        <h2 className="font-heading text-2xl font-semibold">Custom - branded calling campaigns that create real conversations.</h2>
                        <p> We don’t just dial numbers — we build recall, nurture interest, and drive action through personalised, professional brand-aligned calling.</p>
